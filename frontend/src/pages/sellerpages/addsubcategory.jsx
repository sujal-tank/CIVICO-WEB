...
const Addsubcategory = () => {
  ...
  const handlesubmit = async(e) =>  {
    ...
    try {
      const response = await axios.post(`${apiurl}/subcategory/create-subcategory`, obj, {
        headers: {
      ...
      <div className="d-flex">
        ...
        <div className="col-10">
              <div className="main-bg-admin p-5 h-100">
                <h3 className="fs-24 p-2">Add SubCategory</h3>
                <div className="side-box-admin">
                    ...
                    <form className="form-admin d-flex flex-column" onSubmit={handlesubmit}>
                        ...
                        <label className="fw-500 me-2 mt-2">SubCategory Description</label>
