...
const Registersentotp = () => {
  ...
  useEffect(() => {
    document.title = "Log In"; // Change title here
}, []);
  ...
  const handlesubmit = async (e) => {
    e.preventDefault();
    try {
      let res = await axios.post(`${apiurl}/auth/signup/sent-otp`,{mobileNumber},{withCredentials : true})
            ...
            <div className="col-md-8">
              <div className="card card-big d-flex justify-content-center text-center">
                ...
                >
                  ...
                  <div className="signup-btn mt-3  text-center">
                    <button
                      type="submit"
                      className="btn main-bg w-100 text-white"
                    >
                      Continue
...
export default Registersentotp;
